...
const seeds: Seed[] = [
  ...
  { id: 14010, title: "Armenian Tree of Life, Lori region (1909)", size: `4'6" × 8'0"`, age: "1909", condition: "Excellent.", origin: "Caucasian", region: "Lori, Armenia", lead: "A dated Armenian tree-of-life from the Lori region — '1909' woven into the upper cartouche in Armenian script. Indigo field, madder spandrels, the trunk running the length and the canopy spanning the corners.", collection: "antique-caucasian" },
